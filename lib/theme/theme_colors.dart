...
abstract class ThemeColors {
  ...
  Color primaryVariantColor = const Color(0xFFeeeeee);
...
class LightThemeColors extends ThemeColors {
  LightThemeColors() {
    ...
    super.primaryVariantColor = const Color(0xFFeeeeee);
    ...
    super.textColor = const Color(0xFF2f2f2f);
  }
}
...
class DarkThemeColors extends ThemeColors {
  DarkThemeColors() {
    ...
    super.primaryVariantColor = const Color(0xFF000000);
    super.white = const Color(0xFFFFFFFF);
    super.blue = const Color(0xFF4a85fd);
    super.red = const Color(0xFFc42b1c);
    super.green = const Color(0xFF1dbf73);
